...
fruits_vec <- c("peach", "pear", "cherry", "strawberry", "blackberry")
colors_vec <- c("orange", "green", "red", "red", "black")
rounded_vec <- c("rounded", "not rounded", "rounded", "not rounded", "rounded")
...
# If we want the output as a character vector instead of a list:
map2_chr(
    .x = fruits_vec,
    .y = colors_vec,
    \(fruit, color) str_glue("The color of {fruit} is {color}")
